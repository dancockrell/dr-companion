...
check('a guildleader office title selects office art', familyFor("Empaths' Guild, Guildleader's Office") === 'officialOffice')
...
check('an explicitly financial bank selects office art', familyFor('First Provincial Bank') === 'officialOffice')
...
check('a tannery selects tannery art', familyFor("The Tanner's Shop") === 'tannery')
check('a carpet merchant selects carpet-shop art', familyFor('Carpet Merchant') === 'carpetShop')
check('a glove merchant selects glove-shop art', familyFor('Glove Merchant') === 'gloveShop')
...
check('the demo guild office selects office art instead of a hall or leather workshop', /official-office/.test(grokRoomScene('1', 308, "Empaths' Guild, Guildleader's Office", 'A massive mahogany desk faces a leather wing chair.') ?? ''))
