...
const DESCRIBES = {
  ...
  'drc.battle-width.v3': 'How wide the battle column is, as a fraction of the window.',
  'drc.experience-width.v2': 'How wide the experience column is, as a fraction of the window.',
  ...
  'drc.map-height.v1': 'Superseded by `drc.map-height.v3`. Read once, to migrate a genuine v1 customisation; never written.',
  'drc.map-height.v3': 'How tall the map is, as a fraction of the window.',
  ...
  'drc.room-width.v2': 'How wide the room column is, as a fraction of the window.',
