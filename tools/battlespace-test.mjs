...
check('floor glance and floor browser share one controlled selection', /selectedItem=\{floorSelection\}/.test(battle) && /onSelectedItemChange=\{setFloorSelection\}/.test(battle) && /selectedItem === undefined/.test(floor))
