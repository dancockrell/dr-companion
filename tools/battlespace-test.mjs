...
check('room images load while transparent and only high-resolution scenes fade over the fallback', /MIN_ROOM_ART_WIDTH = 960/.test(backdrop) && /MIN_ROOM_ART_HEIGHT = 540/.test(backdrop) && /naturalWidth >= MIN_ROOM_ART_WIDTH/.test(backdrop) && /style\.opacity/.test(backdrop) && /opacity-0 transition-opacity/.test(backdrop) && !/className="absolute inset-0 hidden/.test(backdrop))
