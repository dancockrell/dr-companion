...
check('actor hover cards expose live facts, guarded game actions, and Elanthipedia', /playerProfileFor/.test(radar) && /label="Race"/.test(radar) && /label="Guild"/.test(radar) && /Right now/.test(radar) && /Bestiary/.test(radar) && /requestGameAction\(`look/.test(radar) && /requestGameAction\(`assess/.test(radar) && /Special:Search/.test(radar) && /pointer-events-auto/.test(radar))
