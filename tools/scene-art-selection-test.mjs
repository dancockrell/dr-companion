...
const checks = [
  ...
  ['Brambles begins the audited Magnific walk', roomArtUrl('6', 26, 'Brambles', 'a scarred living thorn barricade'), '/room-scenes/brambles-walk-01.webp'],
  ['Brambles advances through the audited Magnific walk', roomArtUrl('6', 29, 'Brambles', 'a scarred living thorn barricade'), '/room-scenes/brambles-walk-02.webp'],
