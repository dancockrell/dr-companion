...
const CATEGORY_RULES = [
  ...
  { category: 'garden', title: /\b(garden|gardens|courtyard|grove|orchard|arboretum)\b/, lore: /\b(flowerbeds?|hedges?|orchard|cultivated garden|courtyard)\b/, traits: { environment: 'cultivated', subtype: 'garden', civilization: 'settled', elevation: 'low' } },
  ...
  { category: 'deep-forest', title: /\b(forest|woods|wood|understory|brambles|tangle|thicket|jungle)\b/, lore: /\b(forest|woodland|trees|canopy|undergrowth|brambles|thicket)\b/, traits: { environment: 'forest', subtype: 'interior', civilization: 'wilderness', elevation: 'low' } },
