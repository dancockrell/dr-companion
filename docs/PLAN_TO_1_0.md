...
- [x] **H9  Ruby E7 containment: an out-of-process runner for candidate `.lic` scripts** (≈35) (#448)
  ...
  touches: new:ruby/runner.rb, new:ruby/lich_stub.rb, new:ruby/fixtures/, H8>tools/ai-script-repair-test.mjs, .gitattributes, new:tools/ai-script-repair-break-check.mjs, package.json, tools/test-suites.json
  depends-on: H8
