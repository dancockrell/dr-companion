  ...
  return (
    <g aria-hidden="true" className="pointer-events-none select-none">
      {stamps.map((stamp) => {
        ...
        // These are illustrations, not UI icons. Terrain and singular places
        // get enough paper to retain their engraved detail; repeated roof
        // fabric stays a little tighter on dense city sheets.
        const baseDimension = stamp.kind === 'settlement' ? 52 : 64
