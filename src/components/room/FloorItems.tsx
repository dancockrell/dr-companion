      ...
      {selected && (() => {
        ...
        return (
          ...
          >
            ...
            <button type="button" onClick={() => requestGameAction(`look ${target}`, `Look at ${selected}`, 'ui-action')} className="rounded border border-border px-1.5 py-0.5 text-ink-muted hover:text-ink" title={`Look at ${selected}`}>Look</button>
            ...
            <button type="button" onClick={() => requestGameAction(`appraise ${target} quick`, `Appraise ${selected}`, 'ui-action')} className="rounded border border-border px-1.5 py-0.5 text-ink-muted hover:text-ink" title={`Quick-appraise ${selected}`}>Appraise</button>
            <button type="button" onClick={() => requestGameAction(`analyze ${target}`, `Analyze ${selected}`, 'ui-action')} className="rounded border border-border px-1.5 py-0.5 text-ink-muted hover:text-ink" title={`Analyze ${selected}`}>Analyze</button>
