 ...
 * either place is the same pin. This bar used to have no way to pin at all;
 * pinning a combat macro required leaving the fight to open the scripts
 * panel and find the same command listed a second time there. `TaskFlowPanel`
 * no longer lists basic commands at all (see its own doc comment) - this is
 * their one home now, so this is also where pinning them lives.
 */
