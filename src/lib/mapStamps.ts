...
const SERVICE_STAMPS: Partial<Record<LandmarkKind, { kind: MapStampKind; label: string; weight: number }>> = {
  ...
  locksmith: { kind: 'service-forge', label: 'Locksmith', weight: 1.08 },
  jeweler: { kind: 'market', label: 'Jeweler', weight: 1.06 },
  tailor: { kind: 'market', label: 'Tailor', weight: 1.04 },
  food: { kind: 'market', label: 'Provisions', weight: 1.04 },
  stable: { kind: 'service-inn', label: 'Stable', weight: 1.04 },
  performance: { kind: 'service-civic', label: 'Performance hall', weight: 1.08 },
  bath: { kind: 'service-healer', label: 'Bathhouse', weight: 1.02 },
  auction: { kind: 'market', label: 'Auction', weight: 1.08 },
  storage: { kind: 'service-civic', label: 'Storage', weight: 1.02 },
