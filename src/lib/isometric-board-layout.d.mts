...
export function packedRoomPositions(rooms: Array<{ id: number; x?: number | null; y?: number | null; z?: number | null; exits?: Array<{ move: string; to?: number | null }> }>): Map<number, { x: number; y: number; z: number }>
